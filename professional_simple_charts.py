...
def chart6_executive_summary_professional(df):
    """Chart 5: Executive Summary Dashboard - C-Suite Version"""
    ...
    # Panel 1: Crisis Impact (2020) - Executive burgundy gradient
    ax1 = fig.add_subplot(gs[0, 0])
    crisis_countries = ['Spain', 'Greece', 'Croatia', 'Portugal', 'Italy']
    crisis_values = [-65, -60, -58, -57, -55]
    colors1 = ['#C85450', '#C85450', '#D67570', '#D67570', '#E49690']  # Lighter red gradient
    bars1 = ax1.barh(crisis_countries, crisis_values, color=colors1, alpha=0.85, height=0.65)
    
    for i, (country, value) in enumerate(zip(crisis_countries, crisis_values)):
        ax1.text(value - 2.5, i, f'{value}%', va='center', ha='right', 
    ...
    ax2.axvspan(2023, 2024, alpha=0.4, color='#D6E8FF', zorder=0)    # Recovery period - visible blue
    ...
    # C-suite key findings
    key_findings = """
EXECUTIVE SUMMARY:

• UNPRECEDENTED CRISIS: European tourism declined 55-65% in 2020, representing 
...
• STRUCTURAL TRANSFORMATION: Camping sector experienced exceptional growth 
  (+115%), indicating permanent shifts toward outdoor and experiential tourism.

• STRATEGIC IMPLICATIONS: The sector demonstrated remarkable adaptability, 
  emerging stronger and more diversified than pre-pandemic levels.
    """
...
def main():
    ...
    print("5. Creating executive summary dashboard (C-Suite Version)...")
    chart6_executive_summary_professional(df)
